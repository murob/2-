...
<script>
	...
	function idCheck(fn) {
		...
		if (fn.user_id.value == "") {//만약 아이디 입력값이 공백일 경우 실행
			...
			window.open(
					"./pages/id_overapping.jsp?user_id=" + fn.user_id.value,
	...
	function zipcodeFind() {
		new daum.Postcode({
			oncomplete : function(data) {
				...
				if (addr.substr(3, 3) == "서대문" || addr.substr(3, 3) == "동대문"
						|| addr.substr(3, 3) == "영등포") {
					f.gu.value = addr.substr(3, 3);
				} else if (addr.substr(3, 2) == "중구") {
					f.gu.value = "중"
				} else {
					f.gu.value = addr.substr(3, 2);
				}
...
<body>
	<form action="./wagleMember/regist.do" method="get" name="loginFrm"
			...
			<div class="wrap_regiform">
				...
				<table class="regi_table">
					...
					<tr>
						...
						<td><input type="text" class="w01" name="pass1"
							value="asdasd123!@" /></td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						...
						<td><input type="text" class="w01" name="pass2"
							value="asdasd123!@" /></td>
					</tr>
					<tr>
						<td><span class="red">*</span> 이름</td>
						<td><input type="text" class="w01" name="name" value="꺄륵" />
					...
					<tr>
						...
						<td style="padding: 0px 0 5px 5px;"><input type="text"
							class="w02" name="birthday" id="birthday" value="1995-07-11" />
							<img src="./images/pick.jpg" alt="" class="pick" /></td>
					</tr>
					<tr>
						<td><span class="red">*</span> 주소</td>
						<td><input type="text" class="w03" name="zipcode"
							value="06027" />
							<button type="button" onclick="zipcodeFind();">우편번호찾기</button></td>
					</tr>
					<tr>
						<td></td>
						<td><input type="text" class="w04" name="address1"
							value="" /> <input type="text" class="w04"
							name="address2" value="" /><input type="text" class="w04"
							name="gu" value="" readonly /></td>
					</tr>
					<tr>
						<td><span class="red">*</span> 이메일</td>
						<td><input type="text" class="w05" name="email1"
							value="asd123" /> @ <input type="text" class="w05" name="email2"
							value="naver.com" /> <select name="email_domain" class="s01"
