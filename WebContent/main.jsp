	...
	<form method="get">
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu">
							<a class="dropdown-item" href="./wagleboard/list.do?gu=강남">강남구
								...
								href="./wagleboard/list.do?gu=강동">강동구 게시판</a> <a
								class="dropdown-item" href="./wagleboard/list.do?gu=강북">강북구
								게시판</a> <a class="dropdown-item"
								...
								게시판</a> <a class="dropdown-item"
								href="./wagleboard/list.do?gu=중">중구 게시판</a> <a
								class="dropdown-item"
								href="./wagleboard/list.do?gu=중랑">중랑구 게시판</a>
						</div></li>
		...
		<div class="container">
			...
			<div class="main_login">
				<a href="./wagleboard/login.do" style="color: black">로그인/회원가입</a>
			</div>
		</div>
